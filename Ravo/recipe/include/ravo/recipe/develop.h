...
struct DevelopParams
{
    ...
    std::int64_t highlights_mask_child_index = 0;
    std::int64_t highlights_mask_point_index = 0;
    double shadows = 0.0;
    std::optional<std::string> shadows_mask_id;
    std::int64_t shadows_mask_child_index = 0;
    std::int64_t shadows_mask_point_index = 0;
    double whites = 0.0;
    std::optional<std::string> whites_mask_id;
    std::int64_t whites_mask_child_index = 0;
    std::int64_t whites_mask_point_index = 0;
    double blacks = 0.0;
    std::optional<std::string> blacks_mask_id;
    std::int64_t blacks_mask_child_index = 0;
    std::int64_t blacks_mask_point_index = 0;
    double vibrance = 0.0;
