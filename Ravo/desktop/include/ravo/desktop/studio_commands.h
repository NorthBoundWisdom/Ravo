...
inline constexpr auto kLibraryExport = "library.export";
inline constexpr auto kLibraryExportWrite = "library.exportWrite";
...
inline constexpr auto kPhotoSetTags = "photo.setTags";
inline constexpr auto kPhotoSetMetadata = "photo.setMetadata";
inline constexpr auto kPhotoCreateSnapshot = "photo.createSnapshot";
inline constexpr auto kPhotoRestoreHistory = "photo.restoreHistory";
inline constexpr auto kLibrarySetTagFilter = "library.setTagFilter";
...
inline constexpr auto kEditFlipHorizontal = "edit.flipHorizontal";
inline constexpr auto kEditFlipVertical = "edit.flipVertical";
inline constexpr auto kEditCropTool = "edit.cropTool";
