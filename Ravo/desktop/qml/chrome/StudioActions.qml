...
Item {
    ...
    function run(id, argument, source) {
        if (root.controller)
            root.controller.executeCommand(id, argument === undefined ? null : argument,
                                           source === undefined ? "control" : source);
    }
    ...
    function handlePhotoClick(assetId, button, modifiers) {
        ...
        if (!(right && root.presenter && root.presenter.isAssetSelected(assetId) && !shift && !toggle))
            root.run(root.ids.photoSelect, {"id": assetId, "modifiers": mods});
    ...
    function setRating(value) { root.run(root.ids.photoRate, value); }
    ...
    RegisteredAction { id: createLibraryAction; actionId: root.ids.libraryCreate || "" }
    RegisteredAction { id: openLibraryAction; actionId: root.ids.libraryOpen || "" }
    RegisteredAction { id: importPhotosAction; actionId: root.ids.libraryImportFiles || "" }
    RegisteredAction { id: importFolderAction; actionId: root.ids.libraryImportFolder || "" }
    ...
    RegisteredAction { id: gridAction; actionId: root.ids.viewGrid || "" }
    RegisteredAction { id: loupeAction; actionId: root.ids.viewLoupe || "" }
    RegisteredAction { id: developAction; actionId: root.ids.viewDevelop || "" }
    RegisteredAction { id: fitAction; actionId: root.ids.viewFit || "" }
    ...
    RegisteredAction { id: flipHorizontalAction; actionId: root.ids.editFlipHorizontal || "" }
    RegisteredAction { id: flipVerticalAction; actionId: root.ids.editFlipVertical || "" }
    RegisteredAction { id: aboutAction; actionId: root.ids.windowAbout || "" }
    RegisteredAction { id: rating0Action; actionId: root.ids.actionRating0 || "" }
    RegisteredAction { id: rating1Action; actionId: root.ids.actionRating1 || "" }
    RegisteredAction { id: rating2Action; actionId: root.ids.actionRating2 || "" }
    RegisteredAction { id: rating3Action; actionId: root.ids.actionRating3 || "" }
    RegisteredAction { id: rating4Action; actionId: root.ids.actionRating4 || "" }
    RegisteredAction { id: rating5Action; actionId: root.ids.actionRating5 || "" }
    RegisteredAction { id: colorNoneAction; actionId: root.ids.actionColorNone || "" }
    RegisteredAction { id: colorRedAction; actionId: root.ids.actionColorRed || "" }
    RegisteredAction { id: colorYellowAction; actionId: root.ids.actionColorYellow || "" }
    RegisteredAction { id: colorGreenAction; actionId: root.ids.actionColorGreen || "" }
    RegisteredAction { id: colorBlueAction; actionId: root.ids.actionColorBlue || "" }
    RegisteredAction { id: colorPurpleAction; actionId: root.ids.actionColorPurple || "" }
    RegisteredAction { id: removeAction; actionId: root.ids.photoRemove || "" }
    RegisteredAction { id: removeFromDiskAction; actionId: root.ids.photoRemoveFromDisk || "" }
}
