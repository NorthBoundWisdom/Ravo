...
QVariantMap StudioCommandController::ids() const
{
    return {
        ...
        {QStringLiteral("photoOfflineEdit"), QLatin1String(command::kPhotoOfflineEdit)},
        ...
        {QStringLiteral("photoOfflineEditCreate"), QLatin1String(command::kPhotoOfflineEditCreate)},
        {QStringLiteral("photoOfflineEditDelete"), QLatin1String(command::kPhotoOfflineEditDelete)},
        {QStringLiteral("photoOfflineEditPin"), QLatin1String(command::kPhotoOfflineEditPin)},
        {QStringLiteral("photoOfflineEditEvict"), QLatin1String(command::kPhotoOfflineEditEvict)},
        {QStringLiteral("photoOfflineEditList"), QLatin1String(command::kPhotoOfflineEditList)},
