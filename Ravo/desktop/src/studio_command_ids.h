...
inline constexpr auto kLibrarySetLensNameFilter = "studio.library.set_lens_name_filter";
...
inline constexpr auto kPhotoTogglePick = "studio.photo.toggle_pick";
inline constexpr auto kPhotoCullUnflag = "studio.photo.cull_unflag";
...
inline constexpr auto kPhotoEditIn = "studio.photo.edit_in";
inline constexpr auto kPhotoEditInPrepare = "studio.photo.edit_in_prepare";
inline constexpr auto kPhotoEditInCheckReturned = "studio.photo.edit_in_check_returned";
inline constexpr auto kPhotoEditInClearSession = "studio.photo.edit_in_clear_session";
inline constexpr auto kPhotoEditInAbandon = "studio.photo.edit_in_abandon";
inline constexpr auto kPhotoEditInReopen = "studio.photo.edit_in_reopen";
inline constexpr auto kPhotoEditInRefreshStatus = "studio.photo.edit_in_refresh_status";
inline constexpr auto kPhotoOfflineEdit = "studio.photo.offline_edit";
inline constexpr auto kPhotoOfflineEditRefreshStatus = "studio.photo.offline_edit_refresh_status";
inline constexpr auto kPhotoOfflineEditReconnect = "studio.photo.offline_edit_reconnect";
inline constexpr auto kPhotoOfflineEditCreate = "studio.photo.offline_edit_create";
inline constexpr auto kPhotoOfflineEditDelete = "studio.photo.offline_edit_delete";
inline constexpr auto kPhotoOfflineEditPin = "studio.photo.offline_edit_pin";
inline constexpr auto kPhotoOfflineEditEvict = "studio.photo.offline_edit_evict";
inline constexpr auto kPhotoOfflineEditList = "studio.photo.offline_edit_list";
inline constexpr auto kPhotoAiProposal = "studio.photo.ai_proposal";
inline constexpr auto kPhotoAiPropose = "studio.photo.ai_propose";
inline constexpr auto kPhotoAiProposalSelect = "studio.photo.ai_proposal_select";
inline constexpr auto kPhotoAiProposalRefresh = "studio.photo.ai_proposal_refresh";
inline constexpr auto kPhotoAiProposalApply = "studio.photo.ai_proposal_apply";
inline constexpr auto kPhotoAiProposalReject = "studio.photo.ai_proposal_reject";
inline constexpr auto kPhotoAiProposalCancel = "studio.photo.ai_proposal_cancel";
...
inline constexpr auto kViewBurstCompare = "studio.view.burst_compare";
inline constexpr auto kViewBurstComparePrevious = "studio.view.burst_compare_previous";
inline constexpr auto kViewBurstCompareNext = "studio.view.burst_compare_next";
