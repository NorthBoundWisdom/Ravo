...
open a local SQLite catalog, import JPEG/PNG/TIFF/RAW by reference and HEIC/HEIF
primary photos on macOS 14+ ([ADR-0159](../DevDocs/adr/0159-owned-heic-macos-decode.md)), and browse
