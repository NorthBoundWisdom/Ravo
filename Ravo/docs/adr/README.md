...
| [0041](0041-colorharmonizer-smoothing-zero-vertical-slice.md) | Accepted | Extends ADR-0035 with strict v1 singleton import and explicit smoothing-zero Develop/CLI/Catalog/Studio; positive smoothing, masks, GPU, and retirement remain later C14 work. |
