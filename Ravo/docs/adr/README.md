...
| [0033](0033-typed-png-export-options.md) | Accepted | PNG export owns typed 8/16-bit depth and compression 0–9/default 5 through a bounded private libpng RGB8 contract; true RGB16 sources, metadata, and retirement remain later I12 work. |
