...
| [0033](0033-typed-png-export-options.md) | Accepted | PNG export owns typed 8/16-bit depth and compression 0–9/default 5 through bounded private libpng RGB8/RGB16 paths; ADR-0037 supplies the engine-owned RGB16 product source, while metadata and retirement remain later I12 work. |
| [0034](0034-typed-tiff-export-options.md) | Accepted | TIFF export owns typed sample/compression options through a bounded pinned LibTIFF encoder; ADR-0036 adds baseline directory metadata and ADR-0037 supplies real high-precision sources, while complete packets, multipage masks, and retirement remain later I13 work. |
| [0035](0035-colorharmonizer-core-contract.md) | Accepted | Color Harmonizer owns an exact 17-field, profile-aware dt-UCS/RYB smoothing-zero CPU core; import, consumers, recursive-Gaussian smoothing, masks, and retirement remain later C14 tranches. |
| [0036](0036-tiff-baseline-directory-metadata.md) | Accepted | TIFF export embeds bounded resolution, normalized destination, and current writable baseline main-IFD values before atomic publication; complete packets, multipage masks, and retirement remain later I13/S9/J6 work. |
...
| [0038](0038-embedded-export-metadata.md) | Accepted | Rendered JPEG/PNG/TIFF exports embed one Catalog-owned public Exif/XMP/IPTC snapshot before ADR-0032 publication; timezone/GPS, sidecars, and history remain later S9/J6 work. |
