...
| [0034](0034-typed-tiff-export-options.md) | Accepted | TIFF export owns typed sample/compression options through a bounded pinned LibTIFF RGB8 contract; real high-precision sources, metadata, multipage masks, and retirement remain later I13 work. |
