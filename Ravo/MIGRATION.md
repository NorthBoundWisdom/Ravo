...
| Recipe/schema | IOP params/XMP | recipe | In progress | versioned round-trip, explicit upgrades, and bounded strict mappings including exposure v5/v6/v7, Color Checker v1/v2, Color Correction v1, and Color Contrast schema v2 plus both independent v1 upgrades are tested |
...
| CPU preview/pixelpipe | `src/develop` | engine | In progress | bounded PNG, cancellation, full exposure, Color Checker, affine D50 Lab Color Correction, and bounded/unbounded D50 Lab Color Contrast CPU behavior, plus explicit colour operations are tested; complete ROI remains unfinished |
