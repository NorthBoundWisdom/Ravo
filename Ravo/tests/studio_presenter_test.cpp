...
TEST(StudioQmlContract, ColorHarmonizerLoadsNumericControlsWithoutForbiddenPresentation)
{
    ...
    EXPECT_FALSE(section.contains(QStringLiteral("MaskEditor")));
    EXPECT_FALSE(section.contains(QStringLiteral("editColorHarmonizerMask")));
    ...
    EXPECT_FALSE(source.contains(QStringLiteral("editGraduatedMask")));
