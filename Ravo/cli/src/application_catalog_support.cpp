                                                ...
                                                const bool verified)
{
    return JsonValue::Object{
        ...
        {"external_editor_count",
         JsonValue::number(std::to_string(artifact.external_editor_count))},
        {"format_version", JsonValue::number(std::to_string(artifact.format_version))},
