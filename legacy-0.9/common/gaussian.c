...
static void _compute_gauss_params(const float sigma, dt_gaussian_order_t order, float *a0,
...
void dt_gaussian_blur(dt_gaussian_t *g, const float *const in, float *const out)
{
    ...
    const int ch =
        MIN(4, g->channels); // just to appease zealous compiler warnings about stack usage
...
static void _fast_9x9_kernel_1(float *in, float *out, const int width, const int height,
                               const float sigma, const float min, const float max)
{
    float kern[25];
...
#define h4 4
    ...
    for (int row = 0; row < height; row++)
    {
        for (int col = 0; col < width; col++)
        {
            ...
            {
                val = kern[10 + 4] *
                          (in[i - w4 - h2] + in[i - w4 + h2] + in[i - w2 - h4] + in[i - w2 + h4] +
                           in[i + w2 - h4] + in[i + w2 + h4] + in[i + w4 - h2] + in[i + w4 + h2]) +
                      kern[5 + 4] *
                          (in[i - w4 - h1] + in[i - w4 + h1] + in[i - w1 - h4] + in[i - w1 + h4] +
                           in[i + w1 - h4] + in[i + w1 + h4] + in[i + w4 - h1] + in[i + w4 + h1]) +
                      kern[4] * (in[i - w4 + h0] + in[i - h4] + in[i + h4] + in[i + w4 + h0]) +
                      kern[15 + 3] *
                          (in[i - w3 - h3] + in[i - w3 + h3] + in[i + w3 - h3] + in[i + w3 + h3]) +
                      kern[10 + 3] *
                          (in[i - w3 - h2] + in[i - w3 + h2] + in[i - w2 - h3] + in[i - w2 + h3] +
                           in[i + w2 - h3] + in[i + w2 + h3] + in[i + w3 - h2] + in[i + w3 + h2]) +
                      kern[5 + 3] *
                          (in[i - w3 - h1] + in[i - w3 + h1] + in[i - w1 - h3] + in[i - w1 + h3] +
                           in[i + w1 - h3] + in[i + w1 + h3] + in[i + w3 - h1] + in[i + w3 + h1]) +
                      kern[3] * (in[i - w3 + h0] + in[i - h3] + in[i + h3] + in[i + w3 + h0]) +
                      kern[10 + 2] *
                          (in[i - w2 - h2] + in[i - w2 + h2] + in[i + w2 - h2] + in[i + w2 + h2]) +
                      kern[5 + 2] *
                          (in[i - w2 - h1] + in[i - w2 + h1] + in[i - w1 - h2] + in[i - w1 + h2] +
                           in[i + w1 - h2] + in[i + w1 + h2] + in[i + w2 - h1] + in[i + w2 + h1]) +
                      kern[2] * (in[i - w2 + h0] + in[i - h2] + in[i + h2] + in[i + w2 + h0]) +
                      kern[5 + 1] *
                          (in[i - w1 - h1] + in[i - w1 + h1] + in[i + w1 - h1] + in[i + w1 + h1]) +
                    ...
                    if (irow >= 0 && irow < height)
                    {
                        for (int ic = -4; ic <= 4; ic++)
                        {
                            ...
                            if (icol >= 0 && icol < width)
                                val +=
                                    kern[5 * ABS(ir) + ABS(ic)] * in[(size_t)(irow * width + icol)];
                        }
                    }
                }
            }
...
DT_OMP_DECLARE_SIMD(aligned(in, out : 64))
static void _fast_9x9_kernel_2(float *in, float *out, const int width, const int height,
                               const float sigma, const float min, const float max)
{
    float kern[25];
    _calc_9x9_gauss_coeffs(kern, sigma);
    ...
    for (int row = 0; row < height; row++)
    {
        for (int col = 0; col < width; col++)
        {
            ...
            if (col >= 4 && row >= 4 && col < width - 4 && row < height - 4)
            {
                for (int c = 0; c < 2; c++)
                    val[c] =
                        kern[10 + 4] * (in[i - w4 - h2] + in[i - w4 + h2] + in[i - w2 - h4] +
                                        in[i - w2 + h4] + in[i + w2 - h4] + in[i + w2 + h4] +
                                        in[i + w4 - h2] + in[i + w4 + h2]) +
                        kern[5 + 4] * (in[i - w4 - h1] + in[i - w4 + h1] + in[i - w1 - h4] +
                                       in[i - w1 + h4] + in[i + w1 - h4] + in[i + w1 + h4] +
                                       in[i + w4 - h1] + in[i + w4 + h1]) +
                        kern[4] * (in[i - w4 + h0] + in[i - h4] + in[i + h4] + in[i + w4 + h0]) +
                        kern[15 + 3] * (in[i - w3 - h3] + in[i - w3 + h3] + in[i + w3 - h3] +
                                        in[i + w3 + h3]) +
                        kern[10 + 3] * (in[i - w3 - h2] + in[i - w3 + h2] + in[i - w2 - h3] +
                                        in[i - w2 + h3] + in[i + w2 - h3] + in[i + w2 + h3] +
                                        in[i + w3 - h2] + in[i + w3 + h2]) +
                        kern[5 + 3] * (in[i - w3 - h1] + in[i - w3 + h1] + in[i - w1 - h3] +
                                       in[i - w1 + h3] + in[i + w1 - h3] + in[i + w1 + h3] +
                                       in[i + w3 - h1] + in[i + w3 + h1]) +
                        kern[3] * (in[i - w3 + h0] + in[i - h3] + in[i + h3] + in[i + w3 + h0]) +
                        kern[10 + 2] * (in[i - w2 - h2] + in[i - w2 + h2] + in[i + w2 - h2] +
                                        in[i + w2 + h2]) +
                        kern[5 + 2] * (in[i - w2 - h1] + in[i - w2 + h1] + in[i - w1 - h2] +
                                       in[i - w1 + h2] + in[i + w1 - h2] + in[i + w1 + h2] +
                                       in[i + w2 - h1] + in[i + w2 + h1]) +
                        kern[2] * (in[i - w2 + h0] + in[i - h2] + in[i + h2] + in[i + w2 + h0]) +
                        kern[5 + 1] * (in[i - w1 - h1] + in[i - w1 + h1] + in[i + w1 - h1] +
                                       in[i + w1 + h1]) +
                        kern[1] * (in[i - w1 + h0] + in[i - h1] + in[i + h1] + in[i + w1 + h0]) +
                        kern[0] * (in[i + h0]);
            }
...
DT_OMP_DECLARE_SIMD(aligned(in, out : 64))
static void _fast_9x9_kernel_4(float *in, float *out, const int width, const int height,
                               const float sigma, const float min, const float max)
{
    float kern[25];
    _calc_9x9_gauss_coeffs(kern, sigma);
...
void dt_gaussian_fast_blur(float *in, float *out, const int width, const int height,
                           const float sigma, const float min, const float max, const int ch)
{
    float *tmpout = out;
    ...
    if (inplace)
        tmpout = dt_alloc_align_float(bsize);

    if (ch == 1)
        _fast_9x9_kernel_1(in, tmpout, width, height, sigma, min, max);
    else if (ch == 2)
        _fast_9x9_kernel_2(in, tmpout, width, height, sigma, min, max);
    else if (ch == 4)
        _fast_9x9_kernel_4(in, tmpout, width, height, sigma, min, max);
...
dt_gaussian_cl_t *
dt_gaussian_init_cl(const int devid,
                    ...
                    const int order)    // order of gaussian blur
{
    ...
    int kernel_gaussian_transpose = (channels == 1) ?
    ...
    g->dev_temp1 =
        dt_opencl_alloc_device_buffer(devid, sizeof(float) * channels * bwidth * bheight);
    if (!g->dev_temp1)
        goto error;
    g->dev_temp2 =
        dt_opencl_alloc_device_buffer(devid, sizeof(float) * channels * bwidth * bheight);
...
cl_int dt_gaussian_blur_cl(dt_gaussian_cl_t *g, cl_mem dev_in, cl_mem dev_out)
{
    ...
    err = dt_opencl_enqueue_kernel_1d_args(
        devid, kernel_gaussian_column, width, CLARG(dev_temp1), CLARG(dev_temp2), CLARG(width),
        CLARG(height), CLARG(a0), CLARG(a1), CLARG(a2), CLARG(a3), CLARG(b1), CLARG(b2),
    ...
    err = dt_opencl_enqueue_kernel_2d_local_args(
        devid, kernel_gaussian_transpose, sizes, local, CLARG(dev_temp2), CLARG(dev_temp1),
    ...
    // !!)
    err = dt_opencl_enqueue_kernel_1d_args(
        devid, kernel_gaussian_column, height, CLARG(dev_temp1), CLARG(dev_temp2), CLARG(height),
        CLARG(width), CLARG(a0), CLARG(a1), CLARG(a2), CLARG(a3), CLARG(b1), CLARG(b2),
        CLARG(coefp), CLARG(coefn), CLFLARRAY(channels, Labmax), CLFLARRAY(channels, Labmin));
    if (err != CL_SUCCESS)
        return err;
    ...
    return dt_opencl_enqueue_copy_buffer_to_image(devid, dev_temp1, dev_out, 0, CLIMG_ORIGIN,
                                                  region);
}
...
cl_int dt_gaussian_blur_cl_buffer(dt_gaussian_cl_t *g, cl_mem dev_in, cl_mem dev_out)
{
    ...
    err = dt_opencl_enqueue_kernel_1d_args(
        devid, kernel_gaussian_column, width, CLARG(dev_in), CLARG(dev_temp2), CLARG(width),
        CLARG(height), CLARG(a0), CLARG(a1), CLARG(a2), CLARG(a3), CLARG(b1), CLARG(b2),
        CLARG(coefp), CLARG(coefn), CLFLARRAY(channels, Labmax), CLFLARRAY(channels, Labmin));
    if (err != CL_SUCCESS)
        return err;
    ...
    return dt_opencl_enqueue_kernel_2d_local_args(
        devid, kernel_gaussian_transpose, sizes, local, CLARG(dev_temp2), CLARG(dev_out),
        CLARG(height), CLARG(width), CLARG(blocksize), CLLOCAL(bpp * blocksize * (blocksize + 1)));
}

cl_int dt_gaussian_fast_blur_cl_buffer(const int devid, cl_mem dev_in, cl_mem dev_out,
                                       const int width, const int height, const float sigma,
                                       const int ch, const float min, const float max)
{
    ...
    err = dt_opencl_enqueue_kernel_2d_args(
        devid, global->kernel_gaussian_9x9, width, height, CLARG(dev_in), CLARG(tmp_out),
        CLARG(width), CLARG(height), CLARG(ch), CLARG(kern_cl), CLARG(min), CLARG(max));
    if (err != CL_SUCCESS)
        goto error;
...
error:
    ...
    if (inplace)
        dt_opencl_release_mem_object(tmp_out);
