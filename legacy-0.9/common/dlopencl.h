...
typedef cl_int (*dt_clGetPlatformInfo_t)(cl_platform_id, cl_platform_info, size_t, void *,
                                         size_t *);
typedef cl_int (*dt_clGetDeviceIDs_t)(cl_platform_id, cl_device_type, cl_uint, cl_device_id *,
                                      cl_uint *);
typedef cl_int (*dt_clGetDeviceInfo_t)(cl_device_id, cl_device_info, size_t, void *, size_t *);
typedef cl_context (*dt_clCreateContext_t)(const cl_context_properties *, cl_uint,
                                           const cl_device_id *,
...
typedef cl_command_queue (*dt_clCreateCommandQueue_t)(cl_context, cl_device_id,
...
typedef cl_int (*dt_clGetCommandQueueInfo_t)(cl_command_queue, cl_command_queue_info, size_t,
                                             void *, size_t *);
typedef cl_int (*dt_clSetCommandQueueProperty_t)(cl_command_queue, cl_command_queue_properties,
                                                 cl_bool, cl_command_queue_properties *);
typedef cl_mem (*dt_clCreateBuffer_t)(cl_context, cl_mem_flags, size_t, void *, cl_int *);
typedef cl_mem (*dt_clCreateSubBuffer_t)(cl_mem, cl_mem_flags, cl_buffer_create_type, const void *,
                                         cl_int *);
typedef cl_mem (*dt_clCreateImage_t)(cl_context context, cl_mem_flags flags,
                                     const cl_image_format *image_format,
                                     const cl_image_desc *image_desc, void *host_ptr,
                                     cl_int *errcode_ret);
typedef cl_int (*dt_clRetainMemObject_t)(cl_mem);
typedef cl_int (*dt_clReleaseMemObject_t)(cl_mem);
typedef cl_int (*dt_clGetSupportedImageFormats_t)(cl_context, cl_mem_flags, cl_mem_object_type,
...
typedef cl_sampler (*dt_clCreateSampler_t)(cl_context, cl_bool, cl_addressing_mode, cl_filter_mode,
                                           cl_int *);
...
typedef cl_program (*dt_clCreateProgramWithSource_t)(cl_context, cl_uint, const char **,
                                                     const size_t *, cl_int *);
...
typedef cl_int (*dt_clBuildProgram_t)(cl_program, cl_uint, const cl_device_id *, const char *,
                                      void(*), void *);
...
typedef cl_int (*dt_clGetProgramBuildInfo_t)(cl_program, cl_device_id, cl_program_build_info,
                                             size_t, void *, size_t *);
...
typedef cl_int (*dt_clGetKernelWorkGroupInfo_t)(cl_kernel, cl_device_id, cl_kernel_work_group_info,
                                                size_t, void *, size_t *);
...
typedef cl_int (*dt_clSetEventCallback_t)(cl_event, cl_int, void (*)(cl_event, cl_int, void *),
                                          void *);
typedef cl_int (*dt_clGetEventProfilingInfo_t)(cl_event, cl_profiling_info, size_t, void *,
                                               size_t *);
typedef cl_int (*dt_clFlush_t)(cl_command_queue);
typedef cl_int (*dt_clFinish_t)(cl_command_queue);
typedef cl_int (*dt_clEnqueueReadBuffer_t)(cl_command_queue, cl_mem, cl_bool, size_t, size_t,
...
typedef cl_int (*dt_clEnqueueReadBufferRect_t)(cl_command_queue, cl_mem, cl_bool, const size_t *,
                                               ...
                                               cl_event *);
typedef cl_int (*dt_clEnqueueWriteBuffer_t)(cl_command_queue, cl_mem, cl_bool, size_t, size_t,
...
typedef cl_int (*dt_clEnqueueCopyBuffer_t)(cl_command_queue, cl_mem, cl_mem, size_t, size_t, size_t,
...
typedef cl_int (*dt_clEnqueueCopyBufferRect_t)(cl_command_queue, cl_mem, cl_mem, const size_t *,
                                               ...
                                               cl_event *);
typedef cl_int (*dt_clEnqueueReadImage_t)(cl_command_queue, cl_mem, cl_bool, const size_t *,
                                          const size_t *, size_t, size_t, void *, cl_uint,
                                          const cl_event *, cl_event *);
typedef cl_int (*dt_clEnqueueWriteImage_t)(cl_command_queue, cl_mem, cl_bool, const size_t *,
                                           const size_t *, size_t, size_t, const void *, cl_uint,
                                           const cl_event *, cl_event *);
typedef cl_int (*dt_clEnqueueCopyImage_t)(cl_command_queue, cl_mem, cl_mem, const size_t *,
...
typedef cl_int (*dt_clEnqueueCopyImageToBuffer_t)(cl_command_queue, cl_mem, cl_mem, const size_t *,
                                                  ...
                                                  cl_event *);
typedef cl_int (*dt_clEnqueueCopyBufferToImage_t)(cl_command_queue, cl_mem, cl_mem, size_t,
                                                  const size_t *, const size_t *, cl_uint,
                                                  const cl_event *, cl_event *);
typedef void *(*dt_clEnqueueMapBuffer_t)(cl_command_queue, cl_mem, cl_bool, cl_map_flags, size_t,
                                         size_t, cl_uint, const cl_event *, cl_event *, cl_int *);
typedef void *(*dt_clEnqueueMapImage_t)(cl_command_queue, cl_mem, cl_bool, cl_map_flags,
                                        const size_t *, const size_t *, size_t *, size_t *, cl_uint,
                                        const cl_event *, cl_event *, cl_int *);
typedef cl_int (*dt_clEnqueueUnmapMemObject_t)(cl_command_queue, cl_mem, void *, cl_uint,
                                               const cl_event *, cl_event *);
typedef cl_int (*dt_clEnqueueNDRangeKernel_t)(cl_command_queue, cl_kernel, cl_uint, const size_t *,
                                              const size_t *, const size_t *, cl_uint,
                                              const cl_event *, cl_event *);
typedef cl_int (*dt_clEnqueueTask_t)(cl_command_queue, cl_kernel, cl_uint, const cl_event *,
                                     cl_event *);
typedef cl_int (*dt_clEnqueueNativeKernel_t)(cl_command_queue, void (*user_func)(void *), void *,
