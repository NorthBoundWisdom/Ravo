...
static inline void eigf_variance_analysis(const float *const restrict guide, // I
                                          ...
                                          float *const restrict out, const size_t width,
...
// same function as above, but specialized for the case where guide == mask
// for increased performance
void eigf_blending_no_mask(float *const restrict image, const float *const restrict av,
...
static inline void fast_eigf_surface_blur(float *const restrict image, const size_t width,
                                          const size_t height, const float sigma, float feathering,
