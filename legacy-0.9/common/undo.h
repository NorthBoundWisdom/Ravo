...
typedef enum dt_undo_type_t
{
    ...
    DT_UNDO_MASK = 1 << 1,
    DT_UNDO_RATINGS = 1 << 2,
    DT_UNDO_COLORLABELS = 1 << 3,
    DT_UNDO_TAGS = 1 << 4,
    DT_UNDO_METADATA = 1 << 5,
    DT_UNDO_LT_HISTORY = 1 << 6,
    DT_UNDO_FLAGS = 1 << 7,
    DT_UNDO_DATETIME = 1 << 8,
    DT_UNDO_DUPLICATE = 1 << 9,
    DT_UNDO_DEVELOP = DT_UNDO_HISTORY | DT_UNDO_LT_HISTORY | DT_UNDO_MASK | DT_UNDO_TAGS |
    ...
    DT_UNDO_LIGHTTABLE = DT_UNDO_RATINGS | DT_UNDO_COLORLABELS | DT_UNDO_TAGS | DT_UNDO_METADATA |
                         DT_UNDO_LT_HISTORY | DT_UNDO_FLAGS | DT_UNDO_DATETIME | DT_UNDO_DUPLICATE,
    DT_UNDO_ALL = DT_UNDO_DEVELOP | DT_UNDO_LIGHTTABLE
} dt_undo_type_t;
...
void dt_undo_record(dt_undo_t *self, gpointer user_data, const dt_undo_type_t type,
