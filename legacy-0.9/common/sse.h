...
/* minimax polynomial fit of 2**x, in range [-0.5, 0.5[ */
    ...
    expfpart = POLY5(fpart, 9.9999994e-1f, 6.9315308e-1f, 2.4015361e-1f, 5.5826318e-2f,
...
static inline __m128 _mm_log2_ps(__m128 x)
{
    ...
    __m128 exp = _mm_cvtepi32_ps(
        _mm_sub_epi32(_mm_srli_epi32(_mm_and_si128(i, expmask), 23), _mm_set1_epi32(127)));
