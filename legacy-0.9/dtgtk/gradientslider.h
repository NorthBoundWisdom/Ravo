...
G_DECLARE_FINAL_TYPE(GtkDarktableGradientSlider, dtgtk_gradient_slider, DTGTK, GRADIENT_SLIDER,
                     GtkDrawingArea)

#define DTGTK_GRADIENT_SLIDER_MULTIVALUE(obj)                                                      \
    G_TYPE_CHECK_INSTANCE_CAST(obj, dtgtk_gradient_slider_multivalue_get_type(),                   \
                               GtkDarktableGradientSlider)
#define DTGTK_GRADIENT_SLIDER_MULTIVALUE_CLASS(klass)                                              \
    G_TYPE_CHECK_CLASS_CAST(klass, dtgtk_gradient_slider_multivalue_get_type(),                    \
...
void dtgtk_gradient_slider_set_stop(GtkDarktableGradientSlider *gslider, gfloat position,
                                    GdkRGBA color);
...
GtkWidget *dtgtk_gradient_slider_multivalue_new_with_color(GdkRGBA start, GdkRGBA end,
                                                           gint positions);
GtkWidget *dtgtk_gradient_slider_multivalue_new_with_color_and_name(GdkRGBA start, GdkRGBA end,
                                                                    gint positions, gchar *name);
...
void dtgtk_gradient_slider_multivalue_set_marker(GtkDarktableGradientSlider *gslider, gint mark,
                                                 gint pos);
...
void dtgtk_gradient_slider_multivalue_set_picker_meanminmax(GtkDarktableGradientSlider *gslider,
                                                            gdouble mean, gdouble min, gdouble max);
