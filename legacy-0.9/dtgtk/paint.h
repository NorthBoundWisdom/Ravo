...
typedef enum dtgtk_cairo_paint_flags_t
{
    ...
    CPF_FOCUS = 1 << 13,
    CPF_SPECIAL_FLAG =
        1 << 14, // this needs to be the last one. also update shift in dtgtk_cairo_paint_alignment
...
void dtgtk_cairo_paint_line_arrow(cairo_t *cr, gint x, int y, gint w, gint h, gint flags,
                                  void *data);
...
void dtgtk_cairo_paint_switch_inactive(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                       void *data);
/** Paint an always-on switch icon */
void dtgtk_cairo_paint_switch_on(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                 void *data);
/** Paint an always-off switch icon */
void dtgtk_cairo_paint_switch_off(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                  void *data);
...
void dtgtk_cairo_paint_square_plus(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                   void *data);
...
void dtgtk_cairo_paint_plus_simple(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                   void *data);
/** Paint a simple minus icon */
void dtgtk_cairo_paint_minus_simple(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                    void *data);
/** Paint a simple multiply icon */
void dtgtk_cairo_paint_multiply_small(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                      void *data);
/** Paint a treelist icon */
void dtgtk_cairo_paint_treelist(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                void *data);
...
void dtgtk_cairo_paint_draw_structure(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                      void *data);
...
void dtgtk_cairo_paint_unratestar(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                  void *data);
...
void dtgtk_cairo_paint_label_flower(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                    void *data);
...
void dtgtk_cairo_paint_colorpicker_set_values(cairo_t *cr, gint x, gint y, gint w, gint h,
...
void dtgtk_cairo_paint_overlays(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                void *data);
/** paint and */
void dtgtk_cairo_paint_intersection(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                    void *data);
/** paint or */
...
void dtgtk_cairo_paint_bulb_mod(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                void *data);
...
void dtgtk_cairo_paint_histogram_scope(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                       void *data);
/** paint waveform scope icon */
void dtgtk_cairo_paint_waveform_scope(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                      void *data);
/** paint vectorscope icon */
void dtgtk_cairo_paint_vectorscope(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                   void *data);
/** paint split waveform/vectorscope icon */
void dtgtk_cairo_paint_split_waveform_vectorscope(cairo_t *cr, gint x, gint y, gint w, gint h,
                                                  gint flags, void *data);
/** paint linear scale icon */
void dtgtk_cairo_paint_linear_scale(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                    void *data);
/** paint logarithmic scale icon */
void dtgtk_cairo_paint_logarithmic_scale(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                         void *data);
/** paint waveform overlaid icon */
void dtgtk_cairo_paint_waveform_overlaid(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                         void *data);
/** paint RGB parade icon */
void dtgtk_cairo_paint_rgb_parade(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                  void *data);
/** paint Luv icon */
...
void dtgtk_cairo_paint_color_harmony(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                     void *data);
/** paint moving clock */
...
void dtgtk_cairo_paint_modulegroup_favorites(cairo_t *cr, gint x, gint y, gint w, gint h,
                                             gint flags, void *data);
/** paint basics widgets modulegroup icon */
void dtgtk_cairo_paint_modulegroup_basics(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                          void *data);
...
void dtgtk_cairo_paint_modulegroup_grading(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                           void *data);
/** paint technical modulegroup icon */
void dtgtk_cairo_paint_modulegroup_technical(cairo_t *cr, gint x, gint y, gint w, gint h,
                                             gint flags, void *data);
...
void dtgtk_cairo_paint_masks_uniform(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                     void *data);
/** paint a drawn mask icon */
void dtgtk_cairo_paint_masks_drawn(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                   void *data);
/** paint a parametric mask icon */
void dtgtk_cairo_paint_masks_parametric(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                        void *data);
/** paint a combined drawn&parametric mask icon */
void dtgtk_cairo_paint_masks_drawn_and_parametric(cairo_t *cr, gint x, gint y, gint w, gint h,
                                                  gint flags, void *data);
/** paint a raster mask icon */
void dtgtk_cairo_paint_masks_raster(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                    void *data);
...
void dtgtk_cairo_paint_masks_vertgradient(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                          void *data);
/** Paint a brush + inverse icon for masks selection */
void dtgtk_cairo_paint_masks_brush_and_inverse(cairo_t *cr, gint x, gint y, gint w, gint h,
                                               gint flags, void *data);
...
void dtgtk_cairo_paint_masks_sum(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                 void *data);
...
void dtgtk_cairo_paint_tool_clone(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                  void *data);
/** Paint a heal tool for retouch */
void dtgtk_cairo_paint_tool_heal(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                 void *data);
/** Paint a fill tool for retouch */
void dtgtk_cairo_paint_tool_fill(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                 void *data);
/** Paint a blur tool for retouch */
void dtgtk_cairo_paint_tool_blur(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                 void *data);
/** Paint a past icon for retouch */
void dtgtk_cairo_paint_paste_forms(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                   void *data);
/** Paint a cut icon for retouch */
void dtgtk_cairo_paint_cut_forms(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                 void *data);
/** Paint a display scale for retouch */
void dtgtk_cairo_paint_display_wavelet_scale(cairo_t *cr, gint x, gint y, gint w, gint h,
                                             gint flags, void *data);
/** Paint a auto level icon for retouch */
void dtgtk_cairo_paint_auto_levels(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                   void *data);
/** Paint a generic four-pointed compass star */
void dtgtk_cairo_paint_compass_star(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                    void *data);
...
void dtgtk_cairo_paint_lt_mode_culling_dynamic(cairo_t *cr, gint x, gint y, gint w, gint h,
                                               gint flags, void *data);
/** Lighttable: Full Preview */
void dtgtk_cairo_paint_lt_mode_fullpreview(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                           void *data);
...
void dtgtk_cairo_paint_shortcut(cairo_t *cr, gint x, gint y, gint w, gint h, gint flags,
                                void *data);
