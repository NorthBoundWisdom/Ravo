   ...
   */
    struct
    {
        ...
        struct
        {
            ...
            void (*set_zoom)(struct dt_lib_module_t *module, const gint zoom);
            gint (*get_zoom)(struct dt_lib_module_t *module);
            dt_lighttable_layout_t (*get_layout)(struct dt_lib_module_t *module);
            void (*set_layout)(struct dt_lib_module_t *module, const dt_lighttable_layout_t layout);
            void (*culling_preview_refresh)(struct dt_view_t *view);
            void (*culling_preview_reload_overlays)(struct dt_view_t *view);
            dt_lighttable_culling_restriction_t (*get_culling_initial_restriction)(
                struct dt_lib_module_t *module);
            dt_lighttable_culling_restriction_t (*get_culling_restricted_state)(
                struct dt_view_t *view);
            ...
            void (*set_preview_state)(struct dt_view_t *view, const gboolean state,
                                      const gboolean sticky, const gboolean focus,
                                      const dt_lighttable_culling_restriction_t restriction);
            void (*change_offset)(struct dt_view_t *view, const gboolean reset,
...
void dt_view_set_scrollbar(dt_view_t *view, const float hpos, const float hscroll_lower,
                           const float hsize, const float hwinsize, const float vpos,
                           const float vscroll_lower, const float vsize, const float vwinsize);
...
void dt_view_paint_pixbuf(cairo_t *cr, const size_t width, const size_t height, uint8_t *buffer,
                          const size_t processed_width, const size_t processed_height,
                          const dt_window_t window);
