...
static inline int _test_dilate(const uint32_t *img, const size_t i, const size_t w1,
                               const int radius)
{
    int retval = 0;
    retval = img[i - w1 - 1] | img[i - w1] | img[i - w1 + 1] | img[i - 1] | img[i] | img[i + 1] |
             img[i + w1 - 1] | img[i + w1] | img[i + w1 + 1];
    if (retval || (radius < 2))
        return retval;

    const size_t w2 = 2 * w1;
    retval = img[i - w2 - 1] | img[i - w2] | img[i - w2 + 1] | img[i - w1 - 2] | img[i - w1 + 2] |
             img[i - 2] | img[i + 2] | img[i + w1 - 2] | img[i + w1 + 2] | img[i + w2 - 1] |
             img[i + w2] | img[i + w2 + 1];
    if (retval || (radius < 3))
        return retval;
    ...
    retval = img[i - w3 - 2] | img[i - w3 - 1] | img[i - w3] | img[i - w3 + 1] | img[i - w3 + 2] |
             ...
             img[i - w1 - 3] | img[i - w1 + 3] | img[i - 3] | img[i + 3] | img[i + w1 - 3] |
             img[i + w1 + 3] | img[i + w2 - 3] | img[i + w2 - 2] | img[i + w2 + 2] |
             img[i + w2 + 3] | img[i + w3 - 2] | img[i + w3 - 1] | img[i + w3] | img[i + w3 + 1] |
             img[i + w3 + 2];
    if (retval || (radius < 4))
        return retval;
    ...
    retval = img[i - w4 - 2] | img[i - w4 - 1] | img[i - w4] | img[i - w4 + 1] | img[i - w4 + 2] |
             img[i - w3 - 3] | img[i - w3 + 3] | img[i - w2 - 4] | img[i - w2 + 4] |
             img[i - w1 - 4] | img[i - w1 + 4] | img[i - 4] | img[i + 4] | img[i + w1 - 4] |
             img[i + w1 + 4] | img[i + w2 - 4] | img[i + w2 + 4] | img[i + w3 - 3] |
             img[i + w3 + 3] | img[i + w4 - 2] | img[i + w4 - 1] | img[i + w4] | img[i + w4 + 1] |
             img[i + w4 + 2];
    if (retval || (radius < 5))
        return retval;
    ...
    retval = img[i - w5 - 2] | img[i - w5 - 1] | img[i - w5] | img[i - w5 + 1] | img[i - w5 + 2] |
             ...
             img[i - w3 - 4] | img[i - w3 + 4] | img[i - w2 - 5] | img[i - w2 + 5] |
             img[i - w1 - 5] | img[i - w1 + 5] | img[i - 5] | img[i + 5] | img[i + w1 - 5] |
             img[i + w1 + 5] | img[i + w2 - 5] | img[i + w2 + 5] | img[i + w3 - 4] |
             img[i + w3 + 4] | img[i + w4 - 4] | img[i + w4 - 3] | img[i + w4 + 3] |
             img[i + w4 + 4] | img[i + w5 - 2] | img[i + w5 - 1] | img[i + w5] | img[i + w5 + 1] |
             img[i + w5 + 2];
    if (retval || (radius < 6))
        return retval;
    ...
    retval = img[i - w6 - 2] | img[i - w6 - 1] | img[i - w6] | img[i - w6 + 1] | img[i - w6 + 2] |
             ...
             img[i - w4 - 5] | img[i - w4 + 5] | img[i - w3 - 5] | img[i - w3 + 5] |
             img[i - w2 - 6] | img[i - w2 + 6] | img[i - w1 - 6] | img[i - w1 + 6] | img[i - 6] |
             img[i + 6] | img[i + w1 - 6] | img[i + w1 + 6] | img[i + w2 - 6] | img[i + w2 + 6] |
             img[i + w3 - 5] | img[i + w3 + 5] | img[i + w4 - 5] | img[i + w4 + 5] |
             img[i + w5 - 4] | img[i + w5 - 3] | img[i + w5 + 3] | img[i + w5 + 4] |
    ...
    retval = img[i - w7 - 3] | img[i - w7 - 2] | img[i - w7 - 1] | img[i - w7] | img[i - w7 + 1] |
             img[i - w7 + 2] | img[i - w7 + 3] | img[i - w6 - 4] | img[i - w6 - 3] |
             img[i - w6 + 3] | img[i - w6 + 4] | img[i - w5 - 6] | img[i - w5 - 5] |
             img[i - w5 + 5] | img[i - w5 + 6] | img[i - w4 - 6] | img[i - w4 + 6] |
             img[i - w3 - 7] | img[i - w3 - 6] | img[i - w3 + 6] | img[i - w3 + 7] |
             img[i - w2 - 7] | img[i - w2 + 7] | img[i - w1 - 7] | img[i - w1 + 7] | img[i - 7] |
             img[i + 7] | img[i + w1 - 7] | img[i + w1 + 7] | img[i + w2 - 7] | img[i + w2 + 7] |
             img[i + w3 - 7] | img[i + w3 - 6] | img[i + w3 + 6] | img[i + w3 + 7] |
             img[i + w4 - 6] | img[i + w4 + 6] | img[i + w5 - 6] | img[i + w5 - 5] |
             img[i + w5 + 5] | img[i + w5 + 6] | img[i + w6 - 4] | img[i + w6 - 3] |
             img[i + w6 + 3] | img[i + w6 + 4] | img[i + w7 - 3] | img[i + w7 - 2] |
             img[i + w7 - 1] | img[i + w7] | img[i + w7 + 1] | img[i + w7 + 2] | img[i + w7 + 3];
    if (retval || (radius < 8))
        return retval;

    const size_t w8 = 8 * w1;
    retval =
        img[i - w8 - 4] | img[i - w8 - 3] | img[i - w8 - 2] | img[i - w8 - 1] | img[i - w8] |
        img[i - w8 + 1] | img[i - w8 + 2] | img[i - w8 + 3] | img[i - w8 + 4] | img[i - w7 - 6] |
        img[i - w7 - 5] | img[i - w7 - 4] | img[i - w7 + 4] | img[i - w7 + 5] | img[i - w7 + 6] |
        img[i - w6 - 6] | img[i - w6 - 5] | img[i - w6 + 5] | img[i - w6 + 6] | img[i - w5 - 7] |
        img[i - w5 + 6] | img[i - w4 - 8] | img[i - w4 - 7] | img[i - w4 + 7] | img[i - w4 + 8] |
        img[i - w3 - 8] | img[i - w3 - 7] | img[i - w3 + 7] | img[i - w3 + 8] | img[i - w2 - 8] |
        img[i - w2 + 8] | img[i - w1 - 8] | img[i - w1 + 8] | img[i - 8] | img[i + 8] |
        img[i + w1 - 8] | img[i + w1 + 8] | img[i + w2 - 8] | img[i + w2 + 8] | img[i + w3 - 8] |
        img[i + w3 - 7] | img[i + w3 + 7] | img[i + w3 + 8] | img[i + w4 - 8] | img[i + w4 - 7] |
        img[i + w4 + 7] | img[i + w4 + 8] | img[i + w5 - 7] | img[i + w5 + 7] | img[i + w6 - 6] |
        img[i + w6 - 5] | img[i + w6 + 5] | img[i + w6 + 6] | img[i + w7 - 6] | img[i + w7 - 5] |
        img[i + w7 - 4] | img[i + w7 + 4] | img[i + w7 + 5] | img[i - w7 + 6] | img[i + w8 - 4] |
        img[i + w8 - 3] | img[i + w8 - 2] | img[i + w8 - 1] | img[i + w8] | img[i + w8 + 1] |
        img[i + w8 + 2] | img[i + w8 + 3] | img[i + w8 + 4];
    return retval;
}

static inline void _dilating(const uint32_t *img, uint32_t *o, const int w1, const int height,
                             const int border, const int radius)
{
...
static inline int _test_erode(const uint32_t *img, const size_t i, const size_t w1,
                              const int radius)
{
    int retval = 1;
    retval = img[i - w1 - 1] & img[i - w1] & img[i - w1 + 1] & img[i - 1] & img[i] & img[i + 1] &
             img[i + w1 - 1] & img[i + w1] & img[i + w1 + 1];
    if ((retval == 0) || (radius < 2))
        return retval;
...
static inline void _eroding(const uint32_t *img, uint32_t *o, const int w1, const int height,
                            const int border, const int radius)
{
    DT_OMP_FOR(collapse(2))
    for (int row = border; row < height - border; row++)
...
static inline void _intimage_borderfill(uint32_t *d, const int width, const int height,
                                        const int val, const int border)
{
...
static gboolean _floodfill_segmentize(int yin, int xin, dt_iop_segmentation_t *seg, const int w,
                                      const int h, const int id, dt_ff_stack_t *stack)
{
    if (id >= seg->slots - 2)
        return FALSE;
...
gboolean dt_segmentation_init_struct(dt_iop_segmentation_t *seg, const int width, const int height,
                                     const int border, const int islots)
{
    memset(seg, 0, sizeof(dt_iop_segmentation_t));
    ...
    if (!seg->data || !seg->size || !seg->xmin || !seg->xmax || !seg->ymin || !seg->ymax ||
        !seg->val2 || !seg->val2)
    {
