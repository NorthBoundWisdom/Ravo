...
| [../Ravo/ARCHITECTURE.md](../Ravo/ARCHITECTURE.md) | Target, ownership, exact-prefix progressive-preview lifecycle, metadata-analysis, command, data, calibrated interchange response, and engine-private algorithm boundaries |
