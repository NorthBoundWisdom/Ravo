...
| [ProductRoadmap.md](ProductRoadmap.md) | Deferred cross-layer capabilities after the accepted S3.1 mask graph and S3.2 bounded Studio leaf-authoring foundations |
