...
| [0043](0043-canonical-mask-graph-foundation.md) | Accepted; consumers extended by 0108 | S3.1 owns a typed immutable canonical mask DAG, private ROI evaluator, normal mix, and named `supports_mask` operation consumers without completing M1/C14 retirement. |
