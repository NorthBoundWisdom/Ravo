...
| Masks and blending | S3.1 provides canonical all/linear-gradient/circle/ellipse/parametric/group graphs and normal attachments for Color Harmonizer and Graduated ND. Exposure, Color Checker, Color Correction, and Color Contrast retain exact default-unmasked legacy boundaries | Studio authoring, path/brush, further blend modes, M1 acceptance, and strict legacy mask/custom-blend import remain deferred |
