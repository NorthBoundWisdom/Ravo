...
typedef void (*dt_guides_draw_callback)(cairo_t *cr, const float x, const float y, const float w,
...
void dt_guides_add_guide(const char *name, dt_guides_draw_callback draw,
