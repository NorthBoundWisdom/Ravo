...
static const char *ocllib[] = {
    "/System/Library/Frameworks/OpenCL.framework/Versions/Current/OpenCL", NULL};
#else
...
dt_dlopencl_t *dt_dlopencl_init(const char *name)
{
    ...
    if (name != NULL && name[0] != '\0')
    {
        ...
        if (module == NULL)
            dt_print_nts(
                DT_DEBUG_OPENCL | DT_DEBUG_VERBOSE,
                "[dt_dlopencl_init] could not find specified opencl runtime library '%s'\n",
                library);
        else
            dt_print_nts(DT_DEBUG_OPENCL | DT_DEBUG_VERBOSE,
                         "[dt_dlopencl_init] found specified opencl runtime library '%s'\n",
                         library);
    }
    else
    {
        ...
        while (*iter && (module == NULL))
        {
            ...
            if (module == NULL)
                dt_print_nts(
                    DT_DEBUG_OPENCL | DT_DEBUG_VERBOSE,
                    "[dt_dlopencl_init] could not find default opencl runtime library '%s'\n",
                    library);
            else
                dt_print_nts(DT_DEBUG_OPENCL | DT_DEBUG_VERBOSE,
                             "[dt_dlopencl_init] found default opencl runtime library '%s'\n",
                             library);
            iter++;
        }
    }
    ...
    if (module == NULL)
    {
        dt_print_nts(DT_DEBUG_OPENCL,
                     "[dt_dlopencl_init] could not find any opencl runtime library\n");
        return NULL;
    }
    ...
    {
        dt_print_nts(DT_DEBUG_OPENCL,
                     "[dt_dlopencl_init] could not find symbols in opencl runtime library\n");
        free(ocl);
        free(module);
        return NULL;
    }
    ...
    if (sizeof(dt_dlopencl_symbols_t) % sizeof(void (*)(void)) == 0)
    {
        ...
        success =
            success && dt_gmodule_symbol(module, "clGetPlatformInfo",
        ...
        success =
            success && dt_gmodule_symbol(module, "clCreateCommandQueue",
                                         (void (**)(void))&ocl->symbols->dt_clCreateCommandQueue);
        success = success &&
                  dt_gmodule_symbol(module, "clCreateProgramWithSource",
        ...
        success =
            success && dt_gmodule_symbol(module, "clGetProgramBuildInfo",
        ...
        success =
            success && dt_gmodule_symbol(module, "clEnqueueWriteBuffer",
        ...
        success =
            success && dt_gmodule_symbol(module, "clEnqueueNDRangeKernel",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueNDRangeKernel);
        success =
            success && dt_gmodule_symbol(module, "clEnqueueReadImage",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueReadImage);
        success =
            success && dt_gmodule_symbol(module, "clEnqueueWriteImage",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueWriteImage);
        success =
            success && dt_gmodule_symbol(module, "clEnqueueCopyImage",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueCopyImage);
        success = success &&
                  dt_gmodule_symbol(module, "clEnqueueCopyImageToBuffer",
                                    (void (**)(void))&ocl->symbols->dt_clEnqueueCopyImageToBuffer);
        success = success &&
                  dt_gmodule_symbol(module, "clEnqueueCopyBufferToImage",
                                    (void (**)(void))&ocl->symbols->dt_clEnqueueCopyBufferToImage);
        success = success && dt_gmodule_symbol(module, "clFinish",
                                               (void (**)(void))&ocl->symbols->dt_clFinish);
        success =
            success && dt_gmodule_symbol(module, "clEnqueueReadBuffer",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueReadBuffer);
        success =
            success && dt_gmodule_symbol(module, "clReleaseMemObject",
        ...
        success =
            success && dt_gmodule_symbol(module, "clReleaseCommandQueue",
        ...
        success = success &&
                  dt_gmodule_symbol(module, "clGetEventProfilingInfo",
        ...
        success = success &&
                  dt_gmodule_symbol(module, "clCreateProgramWithBinary",
                                    (void (**)(void))&ocl->symbols->dt_clCreateProgramWithBinary);
        success =
            success && dt_gmodule_symbol(module, "clEnqueueCopyBuffer",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueCopyBuffer);
        success =
            success && dt_gmodule_symbol(module, "clEnqueueMapBuffer",
                                         (void (**)(void))&ocl->symbols->dt_clEnqueueMapBuffer);
        success = success &&
                  dt_gmodule_symbol(module, "clEnqueueUnmapMemObject",
                                    (void (**)(void))&ocl->symbols->dt_clEnqueueUnmapMemObject);
        success =
            success && dt_gmodule_symbol(module, "clGetMemObjectInfo",
