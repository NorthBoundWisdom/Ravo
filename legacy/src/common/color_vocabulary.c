...
const char *Lch_to_color_name(dt_aligned_pixel_t color)
{
  ...
  */
    ...
    const skin_color_t skin[SKINS] = {{.name = _("forearm"),
    ...
    for (int elem = 0; elem < SKINS; ++elem)
    {
        ...
        const int match = (Lab[0] > L.bottom && Lab[0] < L.top) &&
                          (Lab[1] > a.bottom && Lab[1] < a.top) &&
                          (Lab[2] > b.bottom && Lab[2] < b.top);

        is_skin = is_skin || match;
        if (match)
            matches[skin[elem].ethnicity] = TRUE;
    }
    ...
    if (step_h == 0)
    {
        // 0° - pinkish red
        if (step_L == 0)
            return _("deep purple"); // L = 10 %
        if (step_L == 1)
            return _("fuchsia"); // L = 30 %
        if (step_L == 2)
            return _("medium magenta"); // L = 50 %
        if (step_L == 3)
            return _("violet pink"); // L = 70 %
        if (step_L == 4)
            return _("plum violet"); // L = 90 %
    }
    else if (step_h == 1)
    {
        // 24° - red
    ...
    else if (step_h == 7)
    {
        // 168° - greenish cyian
        if (step_L == 0)
            return _("dark sea green");
        if (step_L == 1)
            return _("sea green");
        if (step_L == 2)
            return _("teal");
        if (step_L == 3)
            return _("light sea green");
        if (step_L == 4)
            return _("turquoise");
    }
    else if (step_h == 8)
    {
        // 192° - cyan
        if (step_L == 0)
            return _("dark slate gray");
        if (step_L == 1)
            return _("light slate gray");
        if (step_L == 2)
            return _("dark cyan");
        if (step_L == 3)
            return _("aqua");
    ...
    else if (step_h == 9)
    {
        ...
        if (step_L == 2)
            return _("dark cyan");
        if (step_L == 3)
            return _("deep sky blue");
        if (step_L == 4)
            return _("aquamarine blue");
    }
    ...
    else if (step_h == 13)
    {
        ...
        if (step_L == 0)
            return _("indigo");
        if (step_L == 1)
            return _("dark violet");
        if (step_L == 2)
            return _("blue violet");
        if (step_L == 3)
            return _("violet");
        if (step_L == 4)
            return _("plum");
