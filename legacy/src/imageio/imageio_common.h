...
#define FILTERS_ARE_CYGM(filters)                                                                  \
    ((filters) == 0xb4b4b4b4 || (filters) == 0x4b4b4b4b || (filters) == 0x1e1e1e1e ||              \
     (filters) == 0xe1e1e1e1)

#define FILTERS_ARE_RGBE(filters)                                                                  \
    ((filters) == 0x63636363 || (filters) == 0x36363636 || (filters) == 0x9c9c9c9c ||              \
     (filters) == 0xc9c9c9c9)
...
gboolean dt_imageio_export(const dt_imgid_t imgid, const char *filename,
...
gboolean dt_imageio_export_with_flags(
    const dt_imgid_t imgid, const char *filename, struct dt_imageio_module_format_t *format,
...
void dt_imageio_flip_buffers(char *out, const char *in,
                             ...
                             const int wd, const int ht, const int fwd, const int fht,
                             const int stride, const dt_image_orientation_t orientation);
