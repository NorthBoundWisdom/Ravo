...
typedef enum dt_develop_mask_mode_t
{
    ...
    DEVELOP_MASK_MASK_CONDITIONAL =
        (DEVELOP_MASK_MASK | DEVELOP_MASK_CONDITIONAL) // drawn & parametric
...
void dt_develop_blendif_raw_make_mask(dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                      const float *const b, const dt_iop_roi_t *const roi_in,
                                      const dt_iop_roi_t *const roi_out, float *const mask);

void dt_develop_blendif_lab_make_mask(dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                      const float *const b, const dt_iop_roi_t *const roi_in,
                                      const dt_iop_roi_t *const roi_out, float *const mask);

void dt_develop_blendif_rgb_hsl_make_mask(dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                          const float *const b, const dt_iop_roi_t *const roi_in,
                                          const dt_iop_roi_t *const roi_out, float *const mask);

void dt_develop_blendif_rgb_jzczhz_make_mask(dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                             const float *const b, const dt_iop_roi_t *const roi_in,
                                             const dt_iop_roi_t *const roi_out, float *const mask);

/** color blending operators */

void dt_develop_blendif_raw_blend(dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                  float *const b, const dt_iop_roi_t *const roi_in,
                                  const dt_iop_roi_t *const roi_out, const float *const mask,
...
void dt_develop_blendif_rgb_hsl_blend(dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                      float *const b, const dt_iop_roi_t *const roi_in,
                                      const dt_iop_roi_t *const roi_out, const float *const mask,
                                      const dt_dev_pixelpipe_display_mask_t request_mask_display);

void dt_develop_blendif_rgb_jzczhz_blend(
    dt_dev_pixelpipe_iop_t *piece, const float *const a, float *const b,
    const dt_iop_roi_t *const roi_in, const dt_iop_roi_t *const roi_out, const float *const mask,
    const dt_dev_pixelpipe_display_mask_t request_mask_display);
