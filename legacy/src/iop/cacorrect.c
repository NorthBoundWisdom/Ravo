...
const char **description(dt_iop_module_t *self)
{
    return dt_iop_set_description(self, _("correct chromatic aberrations for Bayer sensors"),
                                  _("corrective"), _("linear, raw, scene-referred"),
          ...
          for (int left = -border; left < width; left += ts - border2)
          {
              ...
              if (rrmax < rr1)
              {
                  for (int rr = 0; rr < MIN(border, rr1 - rrmax); rr++)
                      ...
                      {
                          const int c = FC(rr, cc, filters);
                          rgb[c][(rrmax + rr) * ts + cc] =
                              in[(height - rr - 2) * width + left + cc];
                      }
              }
              if (ccmin > 0)
              {
              ...
              if (rrmin > 0 && ccmax < cc1)
              {
                  for (int rr = 0; rr < border; rr++)
                      ...
                      {
                          const int c = FC(rr, cc, filters);
                          rgb[c][(rr)*ts + ccmax + cc] =
                              in[(border2 - rr) * width + (width - cc - 2)];
                      }
              }
              if (rrmax < rr1 && ccmin > 0)
              {
                  for (int rr = 0; rr < MIN(border, rr1 - rrmax); rr++)
                      for (int cc = 0; cc < border; cc++)
                      {
                          const int c = FC(rr, cc, filters);
                          rgb[c][(rrmax + rr) * ts + cc] =
                              in[(height - rr - 2) * width + (border2 - cc)];
                      }
              }
              // end of border fill
              ...
              {
                  int row = rr + top;
                  for (int cc = 3 + (FC(rr, 3, filters) & 1), indx = rr * ts + cc,
                           c = FC(rr, cc, filters);
                       cc < cc1 - 3; cc += 2, indx += 2)
                  {
                      // compute directional weights using image gradients
                      const float wtu =
                          1.f / sqrf(eps + fabsf(rgb[1][indx + v1] - rgb[1][indx - v1]) +
                      ...
                      const float wtd =
                          1.f / sqrf(eps + fabsf(rgb[1][indx - v1] - rgb[1][indx + v1]) +
                                     ...
                                     fabsf(rgb[1][indx + v1] - rgb[1][indx + v3]));
                      const float wtl =
                          1.f / sqrf(eps + fabsf(rgb[1][indx + 1] - rgb[1][indx - 1]) +
                      ...
                      rgb[1][indx] = (wtu * rgb[1][indx - v1] + wtd * rgb[1][indx + v1] +
                                      wtl * rgb[1][indx - 1] + wtr * rgb[1][indx + 1]) /
                                     (wtu + wtd + wtl + wtr);
                  }
                  if (row > -1 && row < height)
                  {
                      for (int col = MAX(left + 3, 0),
                               indx = rr * ts + 3 - (left < 0 ? (left + 3) : 0);
              ...
              {
                  for (int cc = borderh + (FC(rr, 2, filters) & 1), indx = rr * ts + cc,
                           c = FC(rr, cc, filters);
                       cc < cc1 - borderh; cc += 2, indx += 2)
                  {
                      rbhpfv[indx >> 1] = fabsf(fabsf((rgb[1][indx] - rgb[c][indx]) -
                                                      (rgb[1][indx + v4] - rgb[c][indx + v4])) +
                                                fabsf((rgb[1][indx - v4] - rgb[c][indx - v4]) -
                                                      (rgb[1][indx] - rgb[c][indx])) -
                                                fabsf((rgb[1][indx - v4] - rgb[c][indx - v4]) -
                                                      (rgb[1][indx + v4] - rgb[c][indx + v4])));
                      rbhpfh[indx >> 1] = fabsf(fabsf((rgb[1][indx] - rgb[c][indx]) -
                                                      (rgb[1][indx + 4] - rgb[c][indx + 4])) +
                                                fabsf((rgb[1][indx - 4] - rgb[c][indx - 4]) -
                                                      (rgb[1][indx] - rgb[c][indx])) -
                                                fabsf((rgb[1][indx - 4] - rgb[c][indx - 4]) -
                                                      (rgb[1][indx + 4] - rgb[c][indx + 4])));
                      // low and high pass 1D filters of G in vertical/horizontal directions
                      const float glpfv =
                          0.25f * (2.f * rgb[1][indx] + rgb[1][indx + v2] + rgb[1][indx - v2]);
                      const float glpfh =
                          0.25f * (2.f * rgb[1][indx] + rgb[1][indx + 2] + rgb[1][indx - 2]);
                      rblpfv[indx >> 1] =
                          eps + fabsf(glpfv - 0.25f * (2.f * rgb[c][indx] + rgb[c][indx + v2] +
                                                       rgb[c][indx - v2]));
                      rblpfh[indx >> 1] =
                          eps + fabsf(glpfh - 0.25f * (2.f * rgb[c][indx] + rgb[c][indx + 2] +
                                                       rgb[c][indx - 2]));
                      grblpfv[indx >> 1] = glpfv + 0.25f * (2.f * rgb[c][indx] + rgb[c][indx + v2] +
                                                            rgb[c][indx - v2]);
                      grblpfh[indx >> 1] = glpfh + 0.25f * (2.f * rgb[c][indx] + rgb[c][indx + 2] +
                                                            rgb[c][indx - 2]);
                  }
              }
              ...
              {
                  for (int cc = border + (FC(rr, 2, filters) & 1), indx = rr * ts + cc,
                           c = FC(rr, cc, filters);
                       cc < cc1 - border; cc += 2, indx += 2)
                  {
                      ...
                      gdiff = 0.3125f * (rgb[1][indx + 1] - rgb[1][indx - 1]) +
                              0.09375f * (rgb[1][indx + 1 + ts] - rgb[1][indx - 1 + ts] +
                                          rgb[1][indx + 1 - ts] - rgb[1][indx - 1 - ts]);
                      gradwt =
                          fabsf(0.25f * rbhpfh[indx >> 1] +
              ...
              for (int c = 0; c < 2; c++)
              {
                  ...
                  { // vert/hor
                      ...
                      if (coeff[dir][2][c] > eps2)
                      {
                          ...
                          blockwt[vblock * horiz_tiles + hblock] =
                              coeff[dir][2][c] / (eps + coeff[dir][0][c]);
                      }
                      else
                      {
                          CAshift[dir][c] = 17.0f;
                      ...
                      blockshifts[vblock * horiz_tiles + hblock][c][dir] =
                          CAshift[dir][c]; // vert/hor CA shift for R/B
                  } // vert/hor
              } // colour
          }
      }
              ...
              for (int c = 0; c < 2; c++)
              {
                  if (blockdenom[dir][c])
                      blockvar[dir][c] = blocksqave[dir][c] / blockdenom[dir][c] -
                                         sqrf(blockave[dir][c] / blockdenom[dir][c]);
                  else
                  {
          ...
          if (processpasstwo)
          {
              ...
              { // left and right sides
                  for (int c = 0; c < 2; c++)
                  {
                      for (int i = 0; i < 2; i++)
                      {
                          blockshifts[vblock * horiz_tiles][c][i] =
                              blockshifts[(vblock)*horiz_tiles + 2][c][i];
                          blockshifts[vblock * horiz_tiles + horiz_tiles - 1][c][i] =
                              blockshifts[(vblock)*horiz_tiles + horiz_tiles - 3][c][i];
                      }
                  }
              }
                          ...
                          for (int i = 0; i < polyord; i++)
                          {
                              ...
                              for (int j = 0; j < polyord; j++)
                              {
                                  ...
                                  for (int m = 0; m < polyord; m++)
                                  {
                                      ...
                                      {
                                          double inc = powVblock * powHblock *
                                                       blockwt[vblock * horiz_tiles + hblock];
                                          size_t idx =
                                              numpar * (polyord * i + j) + (polyord * m + n);
                                          polymat[c][0][idx] += inc;
                                          polymat[c][1][idx] += inc;
                                          powHblock *= hblock;
                                      }
                                  ...
                                  double blkinc = powVblockInit * powHblockInit *
                                                  blockwt[vblock * horiz_tiles + hblock];
              ...
              if (processpasstwo)
              {
                  ...
                  for (int c = 0; c < 2; c++)
                      for (int dir = 0; dir < 2; dir++)
                      {
                          if (!_LinEqSolve(numpar, polymat[c][dir], shiftmat[c][dir],
                                           fitparams[c][dir]))
                          {
                              dt_print(
                                  DT_DEBUG_PIPE,
                                  "[cacorrect] can't solve linear equations for colour %d direction %d",
                                  c, dir);
                              processpasstwo = FALSE;
                          }
                      }
      ...
      if (processpasstwo)
      {
        ...
        for (int top = -border; top < height; top += ts - border2)
        {
            for (int left = -border; left < width; left += ts - border2)
            {
                ...
                if (rrmax < rr1)
                {
                    for (int rr = 0; rr < MIN(border, rr1 - rrmax); rr++)
                        for (int cc = ccmin; cc < ccmax; cc++)
                        {
                            ...
                            rgb[c][(rrmax + rr) * ts + cc] =
                                in[(height - rr - 2) * width + left + cc];
                            rgb[1][(rrmax + rr) * ts + cc] =
                                Gtmp[(height - rr - 2) * width + left + cc];
                        }
                }
                if (ccmin > 0)
                {
                ...
                if (ccmax < cc1)
                {
                    for (int rr = rrmin; rr < rrmax; rr++)
                        for (int cc = 0; cc < MIN(border, cc1 - ccmax); cc++)
                        {
                            const int c = FC(rr, cc, filters);
                            rgb[c][rr * ts + ccmax + cc] =
                                in[(top + rr) * width + (width - cc - 2)];
                            rgb[1][rr * ts + ccmax + cc] =
                                Gtmp[(top + rr) * width + (width - cc - 2)];
                        }
                }
                // also, fill the image corners
                if (rrmin > 0 && ccmin > 0)
                ...
                if (rrmax < rr1 && ccmax < cc1)
                {
                    for (int rr = 0; rr < MIN(border, rr1 - rrmax); rr++)
                        for (int cc = 0; cc < MIN(border, cc1 - ccmax); cc++)
                        {
                            ...
                            rgb[c][(rrmax + rr) * ts + ccmax + cc] =
                                in[(height - rr - 2) * width + (width - cc - 2)];
                            rgb[1][(rrmax + rr) * ts + ccmax + cc] =
                                Gtmp[(height - rr - 2) * width + (width - cc - 2)];
                        }
                }
                if (rrmin > 0 && ccmax < cc1)
                {
                    for (int rr = 0; rr < border; rr++)
                        for (int cc = 0; cc < MIN(border, cc1 - ccmax); cc++)
                        {
                            ...
                            rgb[c][(rr)*ts + ccmax + cc] =
                                in[(border2 - rr) * width + (width - cc - 2)];
                            rgb[1][(rr)*ts + ccmax + cc] =
                                Gtmp[(border2 - rr) * width + (width - cc - 2)];
                        }
                }
                if (rrmax < rr1 && ccmin > 0)
                {
                    for (int rr = 0; rr < MIN(border, rr1 - rrmax); rr++)
                        for (int cc = 0; cc < border; cc++)
                        {
                            ...
                            rgb[c][(rrmax + rr) * ts + cc] =
                                in[(height - rr - 2) * width + (border2 - cc)];
                            rgb[1][(rrmax + rr) * ts + cc] =
                                Gtmp[(height - rr - 2) * width + (border2 - cc)];
                        }
                }
                // end of border fill
                {
                ...
                for (int rr = borderh; rr < rr1 - borderh; rr++)
                {
                    for (int cc = borderh + (FC(rr, 2, filters) & 1), c = FC(rr, cc, filters);
                         cc < cc1 - borderh; cc += 2)
                    {
                        // perform CA correction using colour ratios or colour differences
                        const float Ginthfloor = interpolatef(
                            shifthfrac[c], rgb[1][(rr + shiftvfloor[c]) * ts + cc + shifthceil[c]],
                            rgb[1][(rr + shiftvfloor[c]) * ts + cc + shifthfloor[c]]);
                        const float Ginthceil = interpolatef(
                            shifthfrac[c], rgb[1][(rr + shiftvceil[c]) * ts + cc + shifthceil[c]],
                ...
                for (int rr = border; rr < rr1 - border; rr++)
                {
                    for (int cc = border + (FC(rr, 2, filters) & 1), c = FC(rr, cc, filters),
                             indx = rr * ts + cc;
                         cc < cc1 - border; cc += 2, indx += 2)
                    {
                        const float grbdiffold = rgb[1][indx] - rgb[c][indx];
                        // interpolate colour difference from optical R/B locations to grid locations
                        const float grbdiffinthfloor = interpolatef(
                            shifthfrac[c], grbdiff[(indx - GRBdir[1][c]) >> 1], grbdiff[indx >> 1]);
                        const float grbdiffinthceil = interpolatef(
                            shifthfrac[c],
                        ...
                        float grbdiffint =
                            interpolatef(shiftvfrac[c], grbdiffinthceil, grbdiffinthfloor);
                        ...
                        else
                        {
                            ...
                            const float p1 =
                                1.0f /
                                (eps + fabsf(rgb[1][indx] - gshift[(indx - GRBdir[1][c]) >> 1]));
                            const float p2 =
                                1.0f / (eps + fabsf(rgb[1][indx] -
                                                    gshift[((rr - GRBdir[0][c]) * ts + cc) >> 1]));
                            const float p3 =
                                1.0f /
                                (eps +
                                 fabsf(
                ...
                {
                    const int c =
                        FC(rr + top, left + border + (FC(rr + top, 2, filters) & 1), filters);
        ...
        for (int row = 0; row < height; row++)
            for (int col = 0 + (FC(row, 0, filters) & 1), indx = (row * width + col) >> 1;
                 col < width; col += 2, indx++)
            {
    ...
    if (avoidshift && processpasstwo)
    {
        ...
        for (int row = 0; row < height; row++)
        {
            ...
            for (int col = firstCol; col < width; col += 2)
            {
                ...
                nongreen[(row / 2) * h_width + col / 2] =
                    CLAMPF(oldraw[oindex] / in[index], 0.5f, 2.0f);
            }
        }
        ...
        if (height % 2)
        {
            ...
            {
                redfactor[(h_height - 1) * h_width + col] =
                    redfactor[(h_height - 2) * h_width + col];
                bluefactor[(h_height - 1) * h_width + col] =
                    bluefactor[(h_height - 2) * h_width + col];
            }
        }
        ...
        if (red)
            dt_gaussian_free(red);
        if (blue)
            dt_gaussian_free(blue);
    }
...
void gui_init(dt_iop_module_t *self)
{
    ...
    gtk_widget_set_tooltip_text(g->avoidshift,
                                _("activate colorshift correction for blue & red channels"));
    ...
    GtkWidget *label_other = dt_ui_label_new(_(
