...
static void _collection_changed_destroy_callback(gpointer instance, int query_change,
                                                 int changed_property, gpointer imgs,
...
static void _image_info_changed_destroy_callback(gpointer instance, gpointer imgs,
                                                 gpointer user_data)
{
    if (imgs)
    {
...
static void _presets_changed_destroy_callback(gpointer instance, gpointer module,
                                              gpointer user_data)
{
    g_free(module);
}
...
static dt_signal_description _signal_description[DT_SIGNAL_COUNT] = {
    /* Global signals */
    [DT_SIGNAL_MOUSE_OVER_IMAGE_CHANGE] = {"dt-global-mouse-over-image-change", NULL, NULL,
                                           G_TYPE_NONE, g_cclosure_marshal_VOID__VOID, 0, NULL,
                                           NULL, FALSE},
    [DT_SIGNAL_ACTIVE_IMAGES_CHANGE] = {"dt-global-active-images-change", NULL, NULL, G_TYPE_NONE,
                                        g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},

    [DT_SIGNAL_CONTROL_REDRAW_ALL] = {"dt-control-redraw-all", NULL, NULL, G_TYPE_NONE,
                                      g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_CONTROL_REDRAW_CENTER] = {"dt-control-redraw-center", NULL, NULL, G_TYPE_NONE,
                                         g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},

    [DT_SIGNAL_VIEWMANAGER_VIEW_CHANGED] = {"dt-viewmanager-view-changed", NULL, NULL, G_TYPE_NONE,
                                            g_cclosure_marshal_generic, 2, pointer_2arg, NULL,
                                            FALSE},
    [DT_SIGNAL_VIEWMANAGER_VIEW_CANNOT_CHANGE] = {"dt-viewmanager-view-cannot-change", NULL, NULL,
                                                  G_TYPE_NONE, g_cclosure_marshal_generic, 2,
                                                  pointer_2arg, NULL, FALSE},
    [DT_SIGNAL_VIEWMANAGER_THUMBTABLE_ACTIVATE] = {"dt-viewmanager-thumbtable-activate", NULL, NULL,
                                                   G_TYPE_NONE, g_cclosure_marshal_VOID__UINT, 1,
                                                   uint_arg, NULL, FALSE},
    [DT_SIGNAL_COLLECTION_CHANGED] = {"dt-collection-changed", NULL, NULL, G_TYPE_NONE,
                                      g_cclosure_marshal_generic, 4, collection_args,
                                      G_CALLBACK(_collection_changed_destroy_callback), FALSE},
    [DT_SIGNAL_SELECTION_CHANGED] = {"dt-selection-changed", NULL, NULL, G_TYPE_NONE,
                                     g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    ...
    [DT_SIGNAL_IMAGE_INFO_CHANGED] = {"dt-image-info-changed", NULL, NULL, G_TYPE_NONE,
                                      g_cclosure_marshal_generic, 1, pointer_arg,
                                      G_CALLBACK(_image_info_changed_destroy_callback), FALSE},
    [DT_SIGNAL_STYLE_CHANGED] = {"dt-style-changed", NULL, NULL, G_TYPE_NONE,
                                 g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_IMAGES_ORDER_CHANGE] = {"dt-images-order-change", NULL, NULL, G_TYPE_NONE,
                                       g_cclosure_marshal_generic, 1, pointer_arg, NULL, FALSE},
    [DT_SIGNAL_FILMROLLS_CHANGED] = {"dt-filmrolls-changed", NULL, NULL, G_TYPE_NONE,
                                     g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_FILMROLLS_IMPORTED] = {"dt-filmrolls-imported", NULL, NULL, G_TYPE_NONE,
                                      g_cclosure_marshal_VOID__UINT, 1, uint_arg, NULL, FALSE},
    [DT_SIGNAL_FILMROLLS_REMOVED] = {"dt-filmrolls-removed", NULL, NULL, G_TYPE_NONE,
                                     g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_PRESETS_CHANGED] = {"dt-presets-changed", NULL, NULL, G_TYPE_NONE,
                                   g_cclosure_marshal_generic, 1, pointer_arg,
                                   G_CALLBACK(_presets_changed_destroy_callback), FALSE},
    [DT_SIGNAL_PRESET_APPLIED] = {"dt-preset-applied", NULL, NULL, G_TYPE_NONE,
                                  g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},

    /* Develop related signals */
    [DT_SIGNAL_DEVELOP_INITIALIZE] = {"dt-develop-initialized", NULL, NULL, G_TYPE_NONE,
                                      g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_MIPMAP_UPDATED] = {"dt-develop-mipmap-updated", NULL, NULL, G_TYPE_NONE,
                                          g_cclosure_marshal_VOID__UINT, 1, uint_arg, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_PREVIEW_PIPE_FINISHED] = {"dt-develop-preview-pipe-finished", NULL, NULL,
                                                 G_TYPE_NONE, g_cclosure_marshal_VOID__VOID, 0,
                                                 NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_PREVIEW2_PIPE_FINISHED] = {"dt-develop-preview2-pipe-finished", NULL, NULL,
                                                  G_TYPE_NONE, g_cclosure_marshal_VOID__VOID, 0,
                                                  NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_UI_PIPE_FINISHED] = {"dt-develop-ui-pipe-finished", NULL, NULL, G_TYPE_NONE,
                                            g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_HISTORY_WILL_CHANGE] = {"dt-develop-history-will-change", NULL, NULL,
                                               G_TYPE_NONE, g_cclosure_marshal_VOID__VOID, 0, NULL,
                                               NULL, FALSE},
    [DT_SIGNAL_DEVELOP_HISTORY_CHANGE] = {"dt-develop-history-change", NULL, NULL, G_TYPE_NONE,
                                          g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_HISTORY_INVALIDATED] = {"dt-develop-history-invalidated", NULL, NULL,
                                               G_TYPE_NONE, g_cclosure_marshal_VOID__VOID, 0, NULL,
                                               NULL, FALSE},
    [DT_SIGNAL_DEVELOP_MODULE_REMOVE] = {"dt-develop-module-remove", NULL, NULL, G_TYPE_NONE,
                                         g_cclosure_marshal_generic, 1, pointer_arg, NULL, TRUE},
    [DT_SIGNAL_DEVELOP_MODULE_MOVED] = {"dt-develop-module-moved", NULL, NULL, G_TYPE_NONE,
                                        g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_IMAGE_CHANGED] = {"dt-develop-image-changed", NULL, NULL, G_TYPE_NONE,
                                         g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_DEVELOP_DISTORT] = {"dt-develop-distort", NULL, NULL, G_TYPE_NONE,
                                   g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},

    [DT_SIGNAL_IMAGE_REMOVED] = {"dt-image-removed", NULL, NULL, G_TYPE_NONE,
                                 g_cclosure_marshal_VOID__UINT, 1, uint_arg, NULL, FALSE},
    [DT_SIGNAL_CONTROL_PROFILE_CHANGED] = {"dt-control-profile-changed", NULL, NULL, G_TYPE_NONE,
                                           g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    [DT_SIGNAL_CONTROL_PROFILE_USER_CHANGED] = {"dt-control-profile-user-changed", NULL, NULL,
                                                G_TYPE_NONE, g_cclosure_marshal_VOID__UINT, 1,
                                                uint_arg, NULL, FALSE},
    [DT_SIGNAL_IMAGE_IMPORT] = {"dt-image-import", NULL, NULL, G_TYPE_NONE,
                                g_cclosure_marshal_VOID__UINT, 1, uint_arg, NULL, FALSE},
    [DT_SIGNAL_IMAGE_EXPORT_TMPFILE] = {"dt-image-export-tmpfile", NULL, NULL, G_TYPE_NONE,
                                        g_cclosure_marshal_generic, 6, image_export_arg, NULL,
                                        TRUE},
    [DT_SIGNAL_IMAGEIO_STORAGE_CHANGE] = {"dt-imageio-storage-change", NULL, NULL, G_TYPE_NONE,
                                          g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
    ...
    [DT_SIGNAL_CONTROL_LOG_REDRAW] = {"dt-control-log-redraw", NULL, NULL, G_TYPE_NONE,
                                      g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},

    [DT_SIGNAL_CONTROL_TOAST_REDRAW] = {"dt-control-toast-redraw", NULL, NULL, G_TYPE_NONE,
                                        g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},

    [DT_SIGNAL_CONTROL_PICKERDATA_READY] = {"dt-control-pickerdata-ready", NULL, NULL, G_TYPE_NONE,
                                            g_cclosure_marshal_generic, 2, pointer_2arg, NULL,
                                            FALSE},

    [DT_SIGNAL_METADATA_UPDATE] = {"dt-metadata-update", NULL, NULL, G_TYPE_NONE,
                                   g_cclosure_marshal_VOID__VOID, 0, NULL, NULL, FALSE},
...
void dt_control_signal_raise(const dt_control_signal_t *ctlsig, dt_signal_t signal, ...)
{
    ...
    else
    {
        ...
        else
        {
            ...
            g_main_context_invoke_full(NULL, G_PRIORITY_HIGH_IDLE, _async_com_callback,
                                       &communication, NULL);
            g_mutex_lock(&communication.end_mutex);
                               ...
                               gpointer user_data)
{
    ...
    g_signal_connect_data(G_OBJECT(ctlsig->sink), _signal_description[signal].name, G_CALLBACK(cb),
                          user_data, NULL, 0);
}

void dt_control_signal_disconnect(const struct dt_control_signal_t *ctlsig, GCallback cb,
                                  gpointer user_data)
{
    _print_trace(-1, DT_DEBUG_SIGNAL_ACT_DISCONNECT, "disconnect");
    g_signal_handlers_disconnect_matched(G_OBJECT(ctlsig->sink),
                                         G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, 0, 0, NULL, cb,
                                         user_data);
}
...
{
    _print_trace(-1, DT_DEBUG_SIGNAL_ACT_DISCONNECT, "disconnect");
    return g_signal_handlers_disconnect_matched(G_OBJECT(ctlsig->sink), G_SIGNAL_MATCH_DATA, 0, 0,
                                                NULL, NULL, user_data);
}

void dt_control_signal_block_by_func(const struct dt_control_signal_t *ctlsig, GCallback cb,
                                     gpointer user_data)
{
    g_signal_handlers_block_by_func(G_OBJECT(ctlsig->sink), cb, user_data);
}

void dt_control_signal_unblock_by_func(const struct dt_control_signal_t *ctlsig, GCallback cb,
                                       gpointer user_data)
{
