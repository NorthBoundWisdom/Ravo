...
static gboolean _ratio_update(dt_lib_filtering_rule_t *rule)
{
  ...
  g_snprintf(query, sizeof(query),
    ...
    dtgtk_range_select_add_range_block(range, 0.5, 0.99, DT_RANGE_BOUND_MIN, _("portrait images"),
                                       nb_portrait);
    dtgtk_range_select_add_range_block(range, 1.0, 1.0, DT_RANGE_BOUND_FIXED, _("square images"),
                                       nb_square);
    dtgtk_range_select_add_range_block(range, 1.01, 2.0, DT_RANGE_BOUND_MAX, _("landscape images"),
                                       nb_landscape);
